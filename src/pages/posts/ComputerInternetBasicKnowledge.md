...
![](../../assets/images/posts/TCP%2020260211133203.png)
...
![](../../assets/images/posts/20260211135612.png)
...
![alt text](../../assets/images/posts/URL%2020260211154424.png)

DNS查询的话，也有四种：

![DNS查询顺序](../../assets/images/posts/DNS%20Search%2020260211154617.png)
...
![HTML Parsing](../../assets/images/posts/HTML%20Parsing%2020260211161325.png)

下一步就是css的解析（首要的就是对于css语法进行转换，尤其是tailwind之类的）

![Css parsing](../../assets/images/posts/CSS%20Parsing%2020260211161500.png)

浏览器绘制的时候，还会碰到**回流**和**重绘**

![Reflow and Repaint](../../assets/images/posts/Reflow%20and%20Repaint%2020260211161719.png)
...
![](../../assets/images/posts/Resolve%20CORS%2020260211170621.png)
...
![](../../assets/images/posts/Read%20stream%2020260212113821.png)
...
![](../../assets/images/posts/send%20ws%2020260212144759.png)

![](../../assets/images/posts/receive%20ws%2020260212144732.png)
...
![](../../assets/images/posts/Network%20Info%2020260212203136.png)
...
![](../../assets/images/posts/Storage%20XSS%2020260212203714.png)

存储型XSS的攻击原理就是：**如果评论没有进行script脚本过滤，那么这条评论的script就会被写入到数据库当中，当每个访问这个帖子的用户从数据库拉取这条评论的时候，都会被XSS攻击**。

![](../../assets/images/posts/DOM%20XSS%2020260212204200.png)

![](../../assets/images/posts/XSS%20TOOLS%2020260212211129.png)

![](../../assets/images/posts/Prevent%20XSS%2020260212211345.png)
